...
export default function ProfessionalRegisterPage() {
  ...
  const handleGoogleDemoSignup = async () => {
    try {
      ...
      toast.success('Signed in with Google Demo (Practice Account)');
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-10 sm:py-16 px-4 sm:px-6 lg:px-8 font-sans">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <p className="mt-1 text-xs sm:text-sm text-slate-500">
          For Doctors, CAs, Lawyers, and Experts to manage bookings & queue
        </p>
      </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  name="name"
                  required
                  placeholder="e.g. Dr. Rajesh Sharma or CA Priya"
                  value={formData.name}
