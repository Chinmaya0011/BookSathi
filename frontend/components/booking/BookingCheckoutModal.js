      ...
      <div className="bg-white rounded-3xl shadow-2xl border border-slate-200 max-w-md w-full p-6 sm:p-8 animate-in zoom-in-95">
        <div className="flex items-center justify-between pb-4 border-b border-slate-100">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-base font-bold text-slate-900">Secure Online Payment</h3>
              <p className="text-[11px] text-slate-400">Gateway Sandbox Mode</p>
            </div>
          </div>
          <button
            type="button"
        ...
        <div className="my-5 p-4 rounded-2xl bg-indigo-50/60 border border-indigo-100/80 text-center">
          ...
          <div className="text-[11px] text-slate-500 mt-1">
            Order Code: {pendingOrder.payment?.paymentCode}
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 text-[11px] text-slate-500">
            ⚡ <strong>Testing Notice:</strong> This simulation invokes the Payment Gateway Adapter. In live deployment, Razorpay or Stripe checkout modal seamlessly opens here.
          </div>
